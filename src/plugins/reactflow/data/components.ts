...
const reactFlowComponent: ApiEntry = {
  ...
  props: [
    ...
    { name: "autoPanOnSelection", type: "boolean", description: "Pan viewport when dragging a selection box near the edge.", default: "true" },
    { name: "autoPanSpeed", type: "number", description: "Speed of auto-panning in pixels per frame.", default: "15" },
    { name: "selectionOnDrag", type: "boolean", description: "Draw a selection box by dragging on the pane (replaces panning when enabled).", default: "false" },
    { name: "edgesFocusable", type: "boolean", description: "Allow edges to be tab-focused for keyboard navigation.", default: "true" },
    { name: "panActivationKeyCode", type: "KeyCode | null", description: "Key that activates panning mode." },
    { name: "multiSelectionKeyCode", type: "KeyCode | null", description: "Key held to add elements to selection.", default: "'Meta'" },
    { name: "zoomActivationKeyCode", type: "KeyCode | null", description: "Key held to enable zoom-on-scroll (when panOnScroll is true).", default: "'Meta'" },
    { name: "disableKeyboardA11y", type: "boolean", description: "Disable all keyboard accessibility shortcuts (arrow-key movement, etc).", default: "false" },
  ],
