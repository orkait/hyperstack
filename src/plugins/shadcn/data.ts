...
export const SHADCN_COMPONENTS: ShadcnComponent[] = [
  ...
  },
  {
    ...
    dataSlots: ["dialog-backdrop", "dialog-viewport", "dialog-popup", "dialog-title", "dialog-description", "dialog-close"],
    variants: [],
    sizes: [],
  ...
  },
  {
    ...
    dataSlots: ["field", "field-label", "field-control", "field-description", "field-error", "field-item", "field-validity"],
    variants: [],
    sizes: [],
    requiresUseClient: false,
  ...
  },
  {
    ...
    dataSlots: ["select-trigger", "select-value", "select-icon", "select-positioner", "select-popup", "select-list", "select-item", "select-item-text", "select-item-indicator", "select-group", "select-group-label"],
    variants: [],
    sizes: ["sm", "md", "lg"],
    requiresUseClient: true,
...
export const SHADCN_RULES = {
  ...
  animation: "data-open / data-closed presence attributes (Base UI uses these, NOT Radix data-state)",
